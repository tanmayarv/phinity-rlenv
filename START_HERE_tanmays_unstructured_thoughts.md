...
like I can provide pe.sv (pe is processing element, the compute unit that does the math, MAC/ FMA w/ saturation) and ask model to give me the generated systolic array with correct connections inferring muxed or combined weightflow and psum dataflow 
